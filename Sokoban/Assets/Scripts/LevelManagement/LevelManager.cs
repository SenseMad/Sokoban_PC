...
namespace Sokoban.LevelManagement
{
    public sealed class LevelManager : SingletonInSceneNoInstance<LevelManager>
    {
        ...
        private CinemachineCamera cinemachineVirtual;
        ...
        public CinemachineCamera CinemachineVirtual
        {
        ...
        private new void Awake()
        {
            ...
            cinemachineVirtual = FindAnyObjectByType<CinemachineCamera>();
        ...
        private void OnEnable()
        {
            ...
            _gridLevel.OnLevelCreated.AddListener(HandleLevelCreated);
        }
        ...
        private void OnDisable()
        {
            ...
            _gridLevel.OnLevelCreated.RemoveListener(HandleLevelCreated);
        }

        //======================================

        private void HandleLevelCreated()
        {
            ...
            if (LevelCompleted || LevelFailed || IsPause)
            {
                yandexGameplayService.StopGameplay();
                IsLevelRunning = false;
                return;
        ...
        public void SetPause(bool parValue)
        {
            ...
            if (!IsLevelMenu && _gridLevel.IsLevelCreated && !LevelCompleted && !LevelFailed)
                yandexGameplayService.StartGameplay();
        }
        ...
        {
            YandexGameplayService.Instance?.StopGameplay();
